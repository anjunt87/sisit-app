...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50 overflow-hidden">
    ...
    <div class="min-h-screen flex">
            ...
            <div class="flex flex-col justify-center items-center w-full p-12 relative z-10">
                ...
                <div class="text-center mb-12 animate-fade-up">
                    ...
                    <div class="grid grid-cols-1 gap-4 mt-12 max-w-sm mx-auto">
                        <div class="flex items-center space-x-3 animate-fade-up-delayed">
                            <div class="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center">
                                <i class="fas fa-shield-alt text-emerald-600"></i>
                            </div>
                            <span class="text-gray-700 font-medium">Keamanan Tingkat Bank</span>
                        </div>
                        <div class="flex items-center space-x-3 animate-fade-up-delayed" style="animation-delay: 0.1s;">
                            <div class="w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center">
                                <i class="fas fa-mobile-alt text-teal-600"></i>
                            </div>
                            <span class="text-gray-700 font-medium">Akses Multi-Platform</span>
                        </div>
                        <div class="flex items-center space-x-3 animate-fade-up-delayed" style="animation-delay: 0.2s;">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 animate-slide-in-right">
            <div class="w-full max-w-md">
                ...
                <div class="glass-morphism rounded-3xl shadow-2xl p-8 lg:p-10 animate-scale-in">
                    <!-- Welcome Text -->
                    ...
                    <!-- Success Message -->
                    @if (session('status'))
                        <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-2xl animate-fade-up">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="loginForm" class="space-y-6">
                        ...
                        <div class="flex justify-center space-x-4 animate-fade-up" style="animation-delay: 0.4s;">
                            <button type="button"
                        ...
                        <button type="submit" id="loginBtn"
                            class="w-full relative overflow-hidden bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-emerald-300 animate-fade-up"
                    ...
                    {{-- 
                    <!-- Divider -->
                    <div class="my-8 flex items-center animate-fade-up" style="animation-delay: 0.6s;">
                    ...
                    <!-- Quick Access -->
                    <div class="text-center animate-fade-up" style="animation-delay: 0.7s;">
                ...
                <!-- Footer -->
                <div class="text-center mt-8 animate-fade-up" style="animation-delay: 0.8s;">
