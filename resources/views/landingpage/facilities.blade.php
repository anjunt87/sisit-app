<!-- Fasilitas Section -->
<section id="facilities" class="py-20 bg-gradient-to-br from-gray-50 to-green-50 px-6">
            ...
            <div class="swiper facilities-swiper">
                <div class="swiper-wrapper mb-16">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-6 rounded-2xl shadow-lg text-center">
                            <div
                                class="w-16 h-16 bg-pink-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-6 rounded-2xl shadow-lg text-center">
                            <div
                                class="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-6 rounded-2xl shadow-lg text-center">
                            <div
                                class="w-16 h-16 bg-yellow-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-6 rounded-2xl shadow-lg text-center">
                            <div
                                class="w-16 h-16 bg-rose-50 rounded-2xl flex items-center justify-center mx-auto mb-4">
